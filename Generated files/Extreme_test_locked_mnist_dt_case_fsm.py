def Lockedinference_rate(pixels, encoded_state_label, encoded_transition_label):
 clock_counter=0; state=0; Label=10; ml_inference_completed=0; state_eval_counter = 0; #assigning dummy default label to 10
 while(Label == 10 or state_eval_counter < 10):
